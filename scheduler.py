...
def schedule_daily(s: AsyncIOScheduler, tz_name: str, slot: str, at_hhmm: str, fn: Callable) -> None:
...
def schedule_once(s: AsyncIOScheduler, run_at: datetime, job_id: str, fn: Callable) -> None:
